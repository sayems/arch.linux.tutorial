...
Arch linux is targeted to advanced linux users. **It does not provide any graphical installer**, It uses a **command line installer**, also, It doesn't come with any pre-installed packages/drivers. ***You have install the packages you want and customize it your own specific needs***. So let's get started..
